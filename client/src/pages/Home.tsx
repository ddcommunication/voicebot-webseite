          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-7">
              ...
              <AccordionContent className="text-muted-foreground text-base leading-relaxed">
                ...
                bestimmen den Preis. Unser Sprachassistent für den Einstieg kostet 29 Cent die Minute zzgl. Aktivierungskosten. <Link href="/termin" className="text-primary hover:underline font-medium">Kontaktieren Sie uns</Link> für ein maßgeschneidertes Angebot, 
