      ...
      <div className="bg-primary text-primary-foreground py-2 text-sm hidden md:block">
        <div className="container flex justify-between items-center">
          <div className="flex gap-6">
            <a href="tel:+4935334807-12" className="flex items-center gap-2 opacity-90 hover:opacity-100 transition-opacity">
              <Phone className="h-3 w-3" /> +49 3533 4807-12
            </a>
      ...
      <footer className="bg-primary text-primary-foreground pt-16 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+4935334807-12" className="hover:text-white transition-colors">+49 3533 4807-12</a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="container border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-primary-foreground/60">
          ...
          <div className="flex items-center gap-6">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/sprachassistent.net/"
              target="_blank"
