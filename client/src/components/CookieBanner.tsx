      ...
      <div className="container max-w-5xl flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-sm text-muted-foreground leading-relaxed text-center md:text-left">
          <p>
            ...
            Dazu zählen Cookies, die für den Betrieb der Seite notwendig sind, sowie solche, die zu Statistikzwecken genutzt werden.
          </p>
          <p className="mt-1">
            Weitere Informationen finden Sie in unserer <Link href="/datenschutz"><span className="underline cursor-pointer hover:text-primary">Datenschutzerklärung</span></Link>.
          </p>
        </div>
