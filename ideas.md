# Design-Konzepte für Voicebot-Webseite

<response>
<text>
## Konzept 1: "Corporate Trust & Clarity"
**Design Movement**: Modern Corporate / Swiss Style
**Core Principles**:
1. **Vertrauen durch Klarheit**: Seriosität steht an erster Stelle. Keine Spielereien, sondern klare Fakten und Strukturen.
2. **Strukturierte Information**: Inhalte werden in klaren Rastern und Karten präsentiert, um komplexe Informationen verdaulich zu machen.
3. **Menschlichkeit in der Technik**: Trotz KI-Thema stehen Menschen im Fokus (Bilder von echten Menschen, warme Akzentfarben).
...
<response>
<text>
## Konzept 2: "Future Tech & Innovation"
**Design Movement**: Neumorphism / Glassmorphism
**Core Principles**:
1. **Technologie erlebbar machen**: Das Design soll "High-Tech" schreien, ohne kalt zu wirken.
2. **Tiefe & Dimension**: Nutzung von Schatten, Unschärfe und Transparenz (Glassmorphism).
3. **Fokus auf Interaktion**: Der Nutzer soll das Gefühl haben, eine moderne App zu bedienen.
...
<response>
<text>
## Konzept 3: "Human-Centric AI"
**Design Movement**: Soft Minimal / Organic Tech
**Core Principles**:
1. **Technologie dient dem Menschen**: Weiche Formen, warme Farben, freundliche Anmutung.
2. **Organische Formen**: Keine harten Kanten, viele Rundungen und Wellen.
3. **Storytelling**: Der Nutzer wird durch eine Geschichte geführt.
